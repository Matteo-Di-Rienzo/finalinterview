        ...
        <div className="container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              Prepare Smarter.<br />
              Interview Faster. <span className="highlight">With AI.</span>
            </h1>

            {/* Subtitle */}
            <p className="hero-subtitle">
              Interview Preparation for Today's Job Market Made Simple.
            </p>

            {/* CTA Button */}
            <div className="hero-cta">
              <Link to="/prepare" className="primary-button">
                Start Demo
